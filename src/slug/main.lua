...
function love.load()
	...
	font2 = love.graphics.newFont("/assets/font1.ttf",20)
	...
	misc_spr = {
		...
		love.graphics.newQuad(237,0,70,87,players[2].spr:getWidth(),players[2].spr:getHeight()),
	}
	...
	bossSprites2 = love.graphics.newImage("/assets/boss_2_spr.png")
	...
	bossSpritesGroups = {
		...
		{
			love.graphics.newQuad(0,135,45,66,bossSprites:getWidth(),bossSprites:getHeight()),
			love.graphics.newQuad(46,135,43,66,bossSprites:getWidth(),bossSprites:getHeight()),
			love.graphics.newQuad(90,144,109,112,bossSprites:getWidth(),bossSprites:getHeight()),
			love.graphics.newQuad(200,144,109,112,bossSprites:getWidth(),bossSprites:getHeight()),
			love.graphics.newQuad(310,144,109,112,bossSprites:getWidth(),bossSprites:getHeight()),
			love.graphics.newQuad(420,144,109,112,bossSprites:getWidth(),bossSprites:getHeight()), -- 420 ;)
			love.graphics.newQuad(530,144,121,43,bossSprites:getWidth(),bossSprites:getHeight()),
			love.graphics.newQuad(530,188,121,38,bossSprites:getWidth(),bossSprites:getHeight()),
			-- 2nd phase sprites --
			love.graphics.newQuad(0,0,340,200,bossSprites2:getWidth(),bossSprites2:getHeight()), --#9
			love.graphics.newQuad(0,200,340,200,bossSprites2:getWidth(),bossSprites2:getHeight()),
			love.graphics.newQuad(0,200*2,340,200,bossSprites2:getWidth(),bossSprites2:getHeight()),
			love.graphics.newQuad(0,200*3,340,200,bossSprites2:getWidth(),bossSprites2:getHeight()),
			love.graphics.newQuad(0,200*4,340,200,bossSprites2:getWidth(),bossSprites2:getHeight()),
			love.graphics.newQuad(0,200*5,340,200,bossSprites2:getWidth(),bossSprites2:getHeight()),
			love.graphics.newQuad(0,200*6,340,200,bossSprites2:getWidth(),bossSprites2:getHeight()),
			-- Laser shooting thingy sprites --
			love.graphics.newQuad(340,0,340,200,bossSprites2:getWidth(),bossSprites2:getHeight()), -- #16
			love.graphics.newQuad(340,200,340,200,bossSprites2:getWidth(),bossSprites2:getHeight()),
			love.graphics.newQuad(340,400,340,200,bossSprites2:getWidth(),bossSprites2:getHeight()),
		},
	}
	
	misc_sprites = love.graphics.newImage("assets/misc.png")
	
	misc_spritesGroups = {
		love.graphics.newQuad(0,0,43,107,misc_sprites:getWidth(),misc_sprites:getHeight()),
		love.graphics.newQuad(44,0,86,107,misc_sprites:getWidth(),misc_sprites:getHeight()),
		love.graphics.newQuad(132,0,104,114,misc_sprites:getWidth(),misc_sprites:getHeight()),
		love.graphics.newQuad(237,0,104,114,misc_sprites:getWidth(),misc_sprites:getHeight()),
		love.graphics.newQuad(342,0,61,102,misc_sprites:getWidth(),misc_sprites:getHeight()),
		love.graphics.newQuad(404,0,61,102,misc_sprites:getWidth(),misc_sprites:getHeight()),
	}
	
	sfx_sounds = {
		love.audio.newSource("/assets/sfx/bomb_1.mp3","static"),
		love.audio.newSource("/assets/sfx/thud_1.mp3","static"),
		love.audio.newSource("/assets/sfx/thud_2.mp3","static"),
		love.audio.newSource("/assets/sfx/shoot_1.mp3","static"),
	}
	
	bg_music = {
		love.audio.newSource("/assets/bg_music1.mp3"),
	}
	
	for i=1, #sfx_sounds do
		--sfx_sounds[i]:setVolume(0.2)
	end
...
function choose_draw()
	...
	love.graphics.setColor(0,0,0,80)
	love.graphics.draw(char_spr[2],players[2].frames[1],maxW/2-30-10,maxH/2-8+3)
	love.graphics.setColor(255,255,255)
	love.graphics.draw(char_spr[2],players[2].frames[1],maxW/2-30,maxH/2-8)
...
function game_doit()
	if timer1 == 0 then
		love.graphics.setColor(255,255,255)
		love.graphics.printf("Press ["..string.upper(players[1].controls[6]).."] to shoot.",0,maxH/2-20,maxW,"center")
	end
end
...
function game_draw()
	...
	if levelNum == 4 then
		for i=1, 10 do
			...
			love.graphics.draw(misc_sprites,misc_spritesGroups[1],(i*200)-10,390+8)
			love.graphics.setColor(255,255,255)
			love.graphics.draw(misc_sprites,misc_spritesGroups[1],i*200,390)
		end
		for i=1, 3 do
			love.graphics.setColor(0,0,0,70)
			love.graphics.draw(misc_sprites,misc_spritesGroups[1],(i*200)-10+2200,390+8)
			love.graphics.setColor(255,255,255)
			love.graphics.draw(misc_sprites,misc_spritesGroups[1],i*200+2200,390)
		end
		love.graphics.draw(misc_sprites,misc_spritesGroups[2],2960,400)
	end
			...
			elseif v.class == "boss" then
				if v.id == 1 then
					...
					if v.talk then
						...
						love.graphics.draw(bossSprites,bossSpritesGroups[v.id][v.talkF],camera.x+110,110,0,0.85)
						
						love.graphics.setFont(font2)
						
						message.draw(camera.x+245,110,maxW-370)
				...
				if v.id == 2 then
					...
					if v.frame == 8 then
						...
						for i=1, 15 do
							local offset = 60
							if i == 7 or i == 2 then
								love.graphics.draw(misc_sprites,misc_spritesGroups[5],v.x,(i*50-50)-380)
							else
								love.graphics.draw(misc_sprites,misc_spritesGroups[num],v.x,(i*offset-offset)-380)
							end
					...
					love.graphics.draw(bossSprites2,bossSpritesGroups[v.id][v.frame1],v.x1-10+v.sprOff1X,v.y1+v.sprOff1Y+8,0,v.scale1X,v.scale1Y)
					
					if v.frame1 == 18 then
						love.graphics.setColor(0,255,0,220)
						if v.dir == "l" then
							love.graphics.rectangle("fill",0,v.y1+60,v.x1+60,20)
						else
							love.graphics.rectangle("fill",v.x1+100,v.y1+60,lvlCameraEndV,20)
						end
					end
					
					love.graphics.setColor(v.color)
				
					love.graphics.draw(bossSprites2,bossSpritesGroups[v.id][v.frame1],v.x1+v.sprOff1X,v.y1+v.sprOff1Y,0,v.scale1X,v.scale1Y)
				
					love.graphics.setColor(0,0,0,100)
					
					love.graphics.draw(bossSprites,bossSpritesGroups[v.id][v.frame],v.x+v.sprOffX-10,v.y+v.sprOffY+8,0,v.scale)
				
					love.graphics.setColor(252,252,252,252)
					
					love.graphics.draw(bossSprites,bossSpritesGroups[v.id][v.frame],v.x+v.sprOffX,v.y+v.sprOffY,0,v.scale)
					...
					if v.talk then
						...
						if v.talkF ~= 0 then
							...
							if v.scriptNum ~= 4 and v.scriptNum ~= 6 and v.scriptNum ~= 9 then
								...
								love.graphics.draw(bossSprites,bossSpritesGroups[v.id][v.talkF],camera.x+110,110)
							
							else
							
								if v.scriptNum == 4 or v.scriptNum == 6 then
							
									love.graphics.draw(players[1].spr,players[1].frames[v.talkF],camera.x+110,100)
									
								end
								
								if v.scriptNum == 9 then
									
									love.graphics.draw(misc_sprites,misc_spritesGroups[v.talkF],camera.x+110,110)
	...
	if playerTWO then
		for i=1, players[2].lives do
			love.graphics.setColor(0,0,0,50)
			love.graphics.draw(players[2].spr,misc_spr[2],(45*i)-40-8,65,0,0.5)
			love.graphics.setColor(255,255,255)
			love.graphics.draw(players[2].spr,misc_spr[2],(45*i)-40,60,0,0.5)
		end
	...
	if showcolls then
		...
		love.graphics.print("CX: "..camera.x.." | CY: "..camera.y,0,40)
...
function love.keypressed(key)
	...
	if gamestate == "doit" then
		if key == players[1].controls[6] and timer1 == 0 then
